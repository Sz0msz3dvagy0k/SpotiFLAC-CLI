...
<p>Want to build your own Linux binary? See the comprehensive <a href="BUILD.md">BUILD.md</a> guide for detailed instructions on building SpotiFLAC-CLI for Linux (x86_64 and ARM64).</p>
<h2>Arguments</h2>
